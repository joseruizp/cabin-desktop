...
public class ImagePanel extends JPanel {
    ...
    public ImagePanel(String path, Dimension dims) {
        this(path, dims, new Point(PWDialog.SCREENDIM.width / 2 - dims.width / 2, PWDialog.SCREENDIM.height / 2 - dims.height / 2));
    }
    ...
    public void setImage(String path, Dimension dims) {
        setImage(path, dims, new Point(PWDialog.SCREENDIM.width / 2 - dims.width / 2, PWDialog.SCREENDIM.height / 2 - dims.height / 2));
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (PWDialog.accepting) {
            try {
                BufferedImage i = ImageIO.read(getClass().getResource("/images/Accept.jpg"));
